	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title mb-4">Create New Schedule</h4>
						<form class="outer-repeater"  method="post" action="{{route('schedules.store')}}">
							@csrf
							<div data-repeater-list="outer-group" class="outer">
								<div data-repeater-item class="outer">
									<div class="form-group row mb-4">
										...
										<div class="col-lg-10">
											<input id="taskname" name="title" type="text" class="form-control" placeholder="Enter Schedule Name...">
										</div>
									</div>
									<div class="form-group row mb-4">
										<label class="col-form-label col-lg-2">Schedule Description</label>
										<div class="col-lg-10">
											<textarea class="form-control" rows="3" placeholder="Enter Schedule Description..." name="description"></textarea>
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-lg-10">
											<select class="form-control select2" name="request_id" id="request_id">
												...
												<option value="{{$request->id}}">{{$request->school->school_name}} - {{$request->schoolClubActivity->schoolClub->club->club_name}} - {{$request->schoolClubActivity->clubActivity->activities_name}}</option>
												@endforeach
											</select>
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-lg-10">
											<div class="input-daterange input-group" >
												<input type="datetime-local" class="form-control" placeholder="Start Date" name="start" id="schedule_time" readonly/>
											<input type="datetime-local" class="form-control" placeholder="End Date" name="end" />
											</div>
										</div>
									</div>
