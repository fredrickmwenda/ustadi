		...
		<div class="row">
			<div class="col-12">
				<div class="page-title-box d-sm-flex align-items-center justify-content-between">
					<h4 class="mb-sm-0 font-size-18">Edit ActivityType</h4>

					<div class="page-title-right">
						<ol class="breadcrumb m-0">
							<li class="breadcrumb-item"><a href="{{route('activities-types.index')}}">Activity Types</a></li>
							<li class="breadcrumb-item active">Edit ActivityType</a></li>
						</ol>
					</div>
					...
					<div class="card-body">
						...
						<form class="needs-validation" method="POST" action="{{route('activities-types.store')}}" novalidate>
							...
							<div class="form-group row mb-4">
								...
								<input id="activity_type_name" name="name" type="text" class="form-control col-lg-10"  required value="{{$activityType->name}}">
							</div>
							<div class="form-group row mb-4">
								...
								<input id="activity_type_description" name="description" type="text" class="form-control col-lg-9"  required value="{{$activityType->description}}">
							</div>
