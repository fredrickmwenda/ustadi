		...
		<div class="row">
			<div class="col-12">
				<div class="page-title-box d-sm-flex align-items-center justify-content-between">
					<h4 class="mb-sm-0 font-size-18">Edit Club </h4>
			...
			<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						...
						<!-- novalidate -->
						<form class="needs-validation" method="POST" action="{{route('clubs.update', $club->id)}}" novalidate enctype="multipart/form-data">
							@csrf
	
							<div class="form-group row mb-4">
								<label for="club_name" class="col-form-label col-lg-2">Club Name <span class="text-danger">*</span></label>
								<div class="col-lg-10">
									<input id="club_name" name="club_name" type="text" class="form-control" placeholder="Enter Club Name..." value="{{$club->club_name}}" required>
								</div>
							</div>
							<div class="form-group row mb-4">
								<label for="club_description" class="col-form-label col-lg-2">Club Description <span class="text-danger">*</span></label>
								<div class="col-lg-10">
								    <textarea class="form-control" id="club_description" name="description" rows="3" placeholder="Enter Club Description..." required>{{$club->description}}</textarea>
								</div>
							</div>
