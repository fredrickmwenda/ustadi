                                ...
                                <!-- <form class="form" method="POST" action="{{ route('profile.update', $user->id) }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8">
                                                <input class="form-control form-control-lg form-control-solid" type="text" name="role" value="{{ $user->role }}" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form class="form" method="POST" action="{{ route('mentors.profile', $mentor->id) }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-lg-8">
                                                <textarea class="form-control" id="specializations" name="specializations" rows="5">
